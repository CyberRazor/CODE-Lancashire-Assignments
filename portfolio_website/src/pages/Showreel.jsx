    ...
    <div className='grid w-50dvw justify-center m-10 '>
                ...
                <div className='grid gap-0 '>
                  <div className='grid grid-cols-2 justify-center w-25dvw'>
                    <p className='text-gray text-lg text-center mx-20 mt-12 mb-2  resize:none'>Highlights reel of my most recent work with Rocksteady Studios & Netherrealm Studios.</p>
                    <p className='text-gray text-lg text-center mx-20 mt-12 mb-2  text-nowrap resize:none'>Selected highlights from my career between 2013-2016.</p>
                  </div>
                  <div className='grid grid-cols-2  justify-center w-25dvw'>
                ...
                <SeparatorBody className='grid justify-center mx-auto mt-6 h-0.5 w-1/2 bg-gradient-to-r from-black to-green'/>
                <h1 className='text-gray font-bold text-7xl mt-20 mb-6'>SOUND <span className='text-black font-medium'>REDESIGNS</span></h1>
                <SeparatorBody className='grid justify-center mx-auto h-0.5 w-1/2 bg-gradient-to-r from-black to-green'/>
                  <p className='text-gray text-lg text-center mx-20 mt-12 mb-4p-2 resize:none'>Here are some short audio redesigns I made during the pandemic. All the source audio was recorded at home during the lockdown.</p>
                <div className='grid grid-cols-2 w-50dvw justify-center '>
